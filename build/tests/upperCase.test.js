...
// uppercase.test.ts
const upperCase_1 = require("../app/upperCase");
// Test suite
describe("Unit Test Upper Case", () => {
    ...
    describe("StringUtils tests", () => {
        ...
        beforeEach(() => {
            sut = new upperCase_1.StringUtils();
        ...
        it("should return correct lower case", () => {
            const sut = new upperCase_1.StringUtils();
    ...
    describe("Section  1", () => {
        ...
        it("should return true when upper case for a input valid string", () => {
            const result = (0, upperCase_1.upperCase)("hello");
            expect(result).toBe("HELLO");
        });
        it("should return true when upper case for a input valid string", () => {
            // Arrange
            const sut = upperCase_1.upperCase;
    ...
    describe("To Upper Case examples", () => {
        it.each([
            ...
            const actual = (0, upperCase_1.upperCase)(input);
            expect(actual).toBe(expected);
        });
        it("should return true when upper case for a input valid string", () => {
            // Arrange
    ...
    describe("Section  1", () => {
        ...
        it("should return true when upper case for a input valid string", () => {
            const actual = (0, upperCase_1.getStringInfo)("Hello");
